                ...
                if ($feedback_list_is_exist == true) {
                    ...
                    for ($i = 0; $i < count($book_id_list); $i += 1) {
                        if ($book_count_list[$i] > 0) {
                            echo '<tr>';
                            echo '<th>' . $book_name_list[$i] . '</th>' . PHP_EOL;
                            echo '<td class = "feedback-table-number">' . $book_count_list[$i] . '題</td>' . PHP_EOL;
                            if ($i < $default_count) {
                                $text_form = '
                                    <td class = "feedback-table-button">
                                    <form class = "form2" method = "post" action = "feedback.php">
                    ...
                    echo '<p class = "main-block-announce">復習リストは空です。</p>';
                }
                ?>
            </div>
