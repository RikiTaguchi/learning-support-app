...
<body>
    ...
    <main>
        <div class = "main-block">
            ...
            if (in_array($book_id, $book_grammar_id_list)) {
                ...
                if ($type == 2) {
                    ...
                    echo '<p class = "main-inner-answer-menu-choices-order">';
                        echo $x[0];
                    echo '</p>';
                    echo '<form class = "main-inner-submit-order form4" method = "post" action = "feedback.php?status=off">';
                ...
                echo '<form class = "main-inner-select form3" method = "post" action = "feedback_answer.php">';
                    echo '<input class = "info_account" type = "text" name = "user_name" value = "' . $user_name . '">';
                    echo '<input class = "info_account" type = "text" name = "login_id" value = "' . $login_id . '">';
                    echo '<input class = "info_account" type = "text" name = "user_pass" value = "' . $user_pass . '">';
            ...
            if (!in_array($book_id, $book_grammar_id_list)) {
                echo '<form class = "feedback-list form2" method = "post" action = "feedback_delete.php">';
                    echo '<input class = "info_account" type = "text" name = "user_name" value = "' . $user_name . '">';
                    echo '<input class = "info_account" type = "text" name = "login_id" value = "' . $login_id . '">';
                    echo '<input class = "info_account" type = "text" name = "user_pass" value = "' . $user_pass . '">';
                    echo '<input type = "text" name = "book_name" value = "' . $book_name . '">';
                    ...
                    if ($check_feedback) {
                        ...
                        echo '<button class = "btn-feedback form-button-set" type = "submit" style = "pointer-events: none;">復習リストから削除済</button>';
                    }

                echo '</form>';
            } else {
                echo '<form class = "feedback-list2 form2" method = "post" action = "feedback_delete.php">';
                    echo '<input class = "info_account" type = "text" name = "user_name" value = "' . $user_name . '">';
                    echo '<input class = "info_account" type = "text" name = "login_id" value = "' . $login_id . '">';
                    echo '<input class = "info_account" type = "text" name = "user_pass" value = "' . $user_pass . '">';
                    echo '<input type = "text" name = "book_name" value = "' . $book_name . '">';
            ...
            ?>
            <form class = "next-word form3" method = "post" action = "feedback_next.php">
                <?php
                echo '<input class = "info_account" type = "text" name = "user_name" value = "' . $user_name . '">';
                echo '<input class = "info_account" type = "text" name = "login_id" value = "' . $login_id . '">';
                echo '<input class = "info_account" type = "text" name = "user_pass" value = "' . $user_pass . '">';
            ...
            <?php echo '<p class = "info-submit" style = "display: none;">' . $submit . '</p>'; ?>
