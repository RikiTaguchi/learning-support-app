...
<html lang = "ja">
    <head>
        ...
        <link href = "../common/css/generate.css?v=1.0.0" rel = "stylesheet">
        ...
        <script src = "../common/js/toggle-structure.js?v=1.0.1"></script>
    ...
    <body>
        ...
        <main class = "main">
            <div class = "main-block">
                <p class = "main-block-title">解析結果</p>
                <button class = "button-howto">
                    <p>構文規則</p>
                </button>
                ...
                <!-- <div class="result-content">
                    <h2>解析結果の詳細</h2>
                    <pre>
                        <?php // echo htmlspecialchars(print_r($temp, true)); ?>
                    </pre>
                </div> -->
